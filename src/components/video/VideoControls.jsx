...
export default function VideoControls({
  ...
  return (
    <div className="h-14 sm:h-16 px-2 sm:px-4 flex items-center justify-center gap-2 sm:gap-3 bg-[#0D1220]/90 backdrop-blur-md border-t border-white/[0.08] shadow-[0_-10px_30px_rgba(0,0,0,0.3)] z-20 shrink-0">
      ...
      {isAgent && (
        <>
          <div className="w-px h-6 sm:h-8 bg-white/10 mx-1 animate-pulse" />
          ...
          {isRecording ? (
            <div className="hover:scale-105 active:scale-95 transition-transform duration-200" data-tooltip="Stop Recording">
              <Button
                ...
                className="animate-pulse-recording rounded-full w-9 h-9 sm:w-11 sm:h-11"
              >
      ...
      <div className="hover:scale-105 active:scale-95 transition-transform duration-200" data-tooltip={endCallLabel}>
        <Button
          ...
          size="icon"
          onClick={onEndCall}
          className="rounded-full w-9 h-9 sm:w-11 sm:h-11 hover:shadow-red-500/20 hover:shadow-lg"
